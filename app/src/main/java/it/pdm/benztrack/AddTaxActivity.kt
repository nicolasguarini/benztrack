...
class AddTaxActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etTitle = findViewById(R.id.etTaxTitle)
        etDate = findViewById(R.id.etTaxDate)
        etTotalSpent = findViewById(R.id.etTaxTotalSpent)
        etOptionalDesc = findViewById(R.id.etTaxOptionalDescription)

        etDate.transformIntoDatePicker(this, "dd/MM/yyyy", Date())
        findViewById<MaterialButton>(R.id.btnTaxRegister).setOnClickListener { registerTax() }
    }

    private fun registerTax() {
